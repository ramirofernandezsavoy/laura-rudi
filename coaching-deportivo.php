...
<head>
	<meta charset="utf-8">
	<title>Coaching Deportivo | Laura Rudi</title>
	<!-- Stylesheets -->
				...
				<div class="row clearfix">
					...
					<div class="content-side col-lg-8 col-md-12 col-sm-12">
						<div class="blog-detail">
							<div class="inner-box">
								<strong>Los secretos del</strong>
								<h2 style="margin: 0px 0px 20px 0px;">
									Coaching deportivo
								</h2>
								<p>El coaching deportivo te ayuda a fortalecer la mentalidad necesaria para superar límites y alcanzar tu máximo potencial. No importa tu disciplina: juntos, trabajaremos en la claridad mental, el enfoque y la resiliencia, cualidades esenciales para el rendimiento sostenido.</p>
								<p> Más allá de la técnica, este coaching te prepara emocionalmente para enfrentar desafíos, gestionar la presión y mantener una actitud ganadora. Con estrategias personalizadas, potenciarás tus fortalezas y desarrollarás la autoconfianza que necesitas para triunfar dentro y fuera del deporte. </p>
								<div class="main-image">
									<img src="assets/images/resource/coaching-deportivo-image.jpg" alt="" />
								</div>
                    ...
                    >
								...
								<blockquote>
									...
									<div class="designation">
										...
										<span>Capitana de las Leonas</span>
									</div>
								</blockquote>
							...
							<div class="sidebar-widget-two about-widget">
								<div class="widget-content">
									...
									<div class="lower-content">
										<h6>Laura Daniela Rudi</h6>
										<div class="text">Coach Ontológico Profesional, Coach Deportivo.</div>
										<!-- Social Box -->
										<ul class="social-box">											
											<li><a target="_blank" href="https://www.instagram.com/coach.laurarudi/" class="fa fa-instagram"></a></li>											
											<li><a href="https://youtube.com/" class="fa fa-youtube-play"></a></li>
										</ul>
									</div>
								</div>
