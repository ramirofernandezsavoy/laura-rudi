...
<head>
<meta charset="utf-8">
<title>Mi gran culpa | Laura Rudi</title>
<!-- Stylesheets -->
							...
							<div class="course-tabs tabs-box">
								...
								<div class="tabs-content">
									...
									<div class="tab active-tab" id="prod-overview">
										<div class="content">
											<p>La culpa es una emoción poderosa que puede afectar nuestra vida diaria. En este taller, aprenderás a identificar y gestionar tus sentimientos de culpa, transformándolos en oportunidades de crecimiento personal.</p>
						...
						<div class="video-intro-widget">
							...
							<div class="lower-content">								
								<ul class="intro-list">
									...
									<li><span class="icon fa fa-book"></span><strong>Temática</strong><i>Gestión de la culpa</i></li>
