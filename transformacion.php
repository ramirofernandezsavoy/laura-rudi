...
<head>
<meta charset="utf-8">
<title>Camino de la transformación | Laura Rudi</title>
<!-- Stylesheets -->
    ...
    <section class="cource-detail-banner-section" style="background-image: url(assets/images/background/talleres.jpg); background-position: 0%;">
		<div class="auto-container">
			<div class="content-box">
				...
				<h1>Camino de la <br> Transformación</h1>
							...
							<div class="course-tabs tabs-box">
								...
								<div class="tabs-content">
									...
									<div class="tab active-tab" id="prod-overview">
										<div class="content">
											<p>El camino de la transformación personal es un viaje profundo hacia el autoconocimiento y el crecimiento. A través de ejercicios prácticos y herramientas de mindfulness, descubrirás cómo recuperar el control de tus emociones y vivir con más calma y enfoque.</p>
											<p>Este taller te brindará un espacio seguro para explorar tus pensamientos y sentimientos, permitiéndote conectar contigo mismo y con los demás de una manera más auténtica.</p>
				...
				<div class="info-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="video-intro-widget">
							<!-- Video Box -->
							<div class="intro-video" style="background-image: url(assets/images/resource/taller-3.jpg)">
							...
							<div class="lower-content">								
								<ul class="intro-list">
									...
									<li><span class="icon fa fa-book"></span><strong>Temática</strong><i>Atravesando la transformación</i></li>
