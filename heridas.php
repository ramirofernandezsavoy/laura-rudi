...
<head>
<meta charset="utf-8">
<title>Heridas de la infancia | Laura Rudi</title>
<!-- Stylesheets -->
    ...
    <section class="cource-detail-banner-section" style="background-image: url(assets/images/background/talleres.jpg); background-position: 0%;">
		<div class="auto-container">
			<div class="content-box">
				...
				<h1>Heridas emocionales <br> de la infancia</h1>
							...
							<div class="course-tabs tabs-box">
								...
								<div class="tabs-content">
									...
									<div class="tab active-tab" id="prod-overview">
										<div class="content">
											<p>Las heridas emocionales de la infancia pueden afectar nuestra vida adulta de maneras profundas y duraderas. En este taller, aprenderás a identificar y sanar estas heridas, permitiéndote vivir una vida más plena y auténtica.</p>
											<p>Exploraremos técnicas de sanación y autoconocimiento que te ayudarán a liberar el dolor del pasado y a construir un futuro más saludable.</p>
						...
						<div class="video-intro-widget">
							...
							<div class="lower-content">								
								<ul class="intro-list">
									...
									<li><span class="icon fa fa-book"></span><strong>Temática</strong><i>Heridas de la infancia</i></li>
